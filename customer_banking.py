...
def main():
    ...
    print(f"Interest earned for the savings account is: {interest_earned:,.2f} and the updated account balance is: {updated_savings_balance:,.2f}")
    ...
    print(f"Interest earned for the CD account is: {interest_earned:,.2f} and the updated account balance is: {updated_cd_balance:,.2f}")
